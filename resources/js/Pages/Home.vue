...
<v-app>
      ...
      <section id="about-me">
        ...
        <v-container class="text-center">
          ...
          <v-responsive
            ...
            max-width="720"
          >
          A Filipino Startup Company  that Aims to Provide  the Best Platform For Developers To Showcase Their Apps on A Community. 
          Our Patented Platform Empowers and Rewards Its Patrons to Dictate the App Development via Feature Request and Vote Point System.
          </v-responsive>
    ...
    >
      <div class="title font-weight-light grey--text text--lighten-1 text-center">
        &copy; {{ (new Date()).getFullYear() }} {{domain}} ® | {{trademark}} ™
      </div>
    </v-footer>
  </v-app>
</template>
...
export default {
    ...
    created() {
        ...
        this.trademark = this.$page.app.name
    },
    methods: {
        login() {
