...
Component.options.__file = "C:\\Users\\uriah\\sites\\www\\jerichoesber\\resources\\assets\\js\\pages\\Courses.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-d3c1e4de", Component.options)
  } else {
    hotAPI.reload("data-v-d3c1e4de", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-d3c1e4de", module.exports)
  }
}
